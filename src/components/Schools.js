        ...
        <Container className="text-center py-4">
          ...
          <Form className="w-75 mx-auto nav-form">
            <Form.Group controlId="exampleForm.SelectCustom">
              <Form.Control
                as="select"
                custom
                onChange={(e) => shoot(e.target.value)}
              >
          ...
          <Row className="mx-auto justify-content-center my-3 navs-works">
            <ul className="our-works p-0 m-0 w-100 justify-content-between d-flex">
              <button
                onClick={() => shoot("all")}
                className={`btn ${filterOption === "all" ? "active" : ""}`}
              >
                ALL PROJECTS
              </button>
              <button
                onClick={() => shoot("residential")}
                className={`btn ${
                  filterOption === "residential" ? "active" : ""
                }`}
              >
                RESIDENTIAL
              </button>
              <button
                onClick={() => shoot("office")}
                className={`btn ${filterOption === "office" ? "active" : ""}`}
              >
                OFFICE
              </button>
              <button
                onClick={() => shoot("hospital")}
                className={`btn ${filterOption === "hospital" ? "active" : ""}`}
              >
                HOSPITAL
              </button>
              <button
                onClick={() => shoot("hotel")}
                className={`btn ${filterOption === "hotel" ? "active" : ""}`}
              >
                HOTEL
              </button>
              <button
                onClick={() => shoot("restaurant")}
                className={`btn ${
                  filterOption === "restaurant" ? "active" : ""
                }`}
              >
                RESTAURANT
              </button>
              ...
              <Col sm={12} md={6} lg={4} key={d.id}>
                <Fade direction={d.direction}>
                  <div className="mb-5 text-center text-md-left">
                    ...
                    <p className="text-center text-md-left">{d.description}</p>
                  </div>
                </Fade>
              </Col>
            ))}
